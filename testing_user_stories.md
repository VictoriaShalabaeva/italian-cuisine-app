...
## I want to organize my recipes (to create, edit or delete recipes).
  ...
  - Once a new recipe is added to the profile, there is a possibility to edit or delete it.
    ...
    <img src="static/images/testing/edit-delete-btn.jpg" alt="Edit and delete buttons." width="200px" height="auto">
  &nbsp;

  - By clicking an *Edit* button, users can make changes in the recipe form.

    <img src="static/images/testing/edit-recipe-page.jpg" alt="Edit recipe page." width="500px" height="auto">
  &nbsp;

  - By clicking a *Delete* button, users will be asked whether they are sure to delete a recipe.

    <img src="static/images/testing/delete-modal.jpg" alt="Login page." width="500px" height="auto">
&nbsp;
...
## I want to share my own recipes with others.
  ...
  - Recipes of different users are displayed on *All Recipes" page. Users can view recipes of others.
    ...
    <img src="static/images/testing/created-by.jpg" alt="Other users can view your recipes." width="500px" height="auto">